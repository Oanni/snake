...
class Apple(GameObject):
    ...
    def randomize_position(
        ...
        if free_cells:
            ...
            # Если все ячейки заняты (маловероятно)
...
class Snake(GameObject):
    ...
    def move(self, grow: bool = False):
        ...
        # Вычисляем новую позицию головы с учетом границ
    ...
    def draw(self, screen: pygame.Surface,
             last_tail_position: Tuple[int, int] = None):
        """
        ...
        """
        # Затираем след, если змейка не растет
